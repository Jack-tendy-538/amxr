...
if __name__ == "__main__":
    ...
    # 例如：0-东升农场, 1-新圩镇, 2-石羊镇, 3-金陵镇, 4-陶岭镇, 5-枧头镇
    # ------------------------------
    ...
    d_matrix = np.array([
        ...
        [49.101, 0.000, 11.525, 14.921, 15.996, 15.877],   # 1 -> 各点
        [57.540, 11.525, 0.000, 24.473, 25.549, 25.430],   # 2 -> 各点
        [34.172, 14.921, 24.473, 0.000, 1.063,  0.957],    # 3 -> 各点
        [33.108, 15.996, 25.549, 1.063,  0.000, 1.331],    # 4 -> 各点
        [34.408, 15.877, 25.430, 0.957,  1.331,  0.000]     # 5 -> 各点
    ])
    # 补全对称
